"""
Django settings for new_sales_project project.
...
ROOT_URLCONF = "new_sales_project.urls"
...
WSGI_APPLICATION = "new_sales_project.wsgi.application"
...
# Increase the number of allowed fields in a single request
